...
const monday = (time) => 
{
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "حلقات اختيارية او تراتيل 3")
    }
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "حلقات اختيارية او تراتيل 2")
    }
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "حلقات اختياريه حرة")
    }
