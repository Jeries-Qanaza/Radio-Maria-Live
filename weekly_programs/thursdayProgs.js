...
const thursday = (time) => 
{
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "شخصية ورسالة")
    }
    else if(time>=7&&time<8)
    {
        obj=  AllPrograms.find(x => x.progName == "المسبحة اسرار النور")
    }
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "اسئلة المستمعين")
    }
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "اسرار النور")
    }
