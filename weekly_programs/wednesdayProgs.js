...
const wednesday = (time) => 
{
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "منائر القديسن")
    }
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "التبشير الملائكي + مسبحة")
    }
    ...
    {
        obj=  AllPrograms.find(x => x.progName == "اجوبة للستمعين")
    }
